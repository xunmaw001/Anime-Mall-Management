		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					...
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' type="success" @click="search()">查询</el-button>
				</el-row>

				<el-row :style='{"margin":"20px 0","display":"flex"}'>
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>


					<download-excel v-if="isAuth('orders'+'/'+orderStatus,'导出')" class="export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "订单.xls">
						<!-- 导出excel -->
						<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' type="danger">导出</el-button>
					</download-excel>


					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销量')" type="warning" @click="dayNumberChartDialog()">日销量</el-button>

					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销量')" type="warning" @click="monthNumberChartDialog()">月销量</el-button>
            
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销量')" type="warning" @click="yearNumberChartDialog()">年销量</el-button>
            
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}'	v-if="isAuth('orders'+'/'+orderStatus,'品销量')"	type="warning"	@click="goodnameNumberChartDialog()">商品销量</el-button>
            
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'类销量')" type="warning" @click="goodtypeNumberChartDialog()">类型销量</el-button>
            
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销额')" type="warning" @click="dayAmountChartDialog()">日销额</el-button>
            
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销额')" type="warning" @click="monthAmountChartDialog()">月销额</el-button>
            
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销额')" type="warning" @click="yearAmountChartDialog()">年销额</el-button>
            
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'品销额')" type="warning" @click="goodnameAmountChartDialog()">商品销额</el-button>
            
					<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'类销额')" type="warning" @click="goodtypeAmountChartDialog()">类型销额</el-button>
				</el-row>
			</el-form>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('orders'+'/'+orderStatus,'查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('orders'+'/'+orderStatus,'修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>

							<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'物流')" type="primary" size="mini" @click="logisticsUpdate(scope.row.id)">物流</el-button>
                
							<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'发货')" type="primary" size="mini" @click="updateHandler(scope.row)">发货</el-button>

							<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'确认收货')" type="primary" size="mini" @click="updateHandler2(scope.row)">确认收货</el-button>




							<el-button :style='{"border":"2px solid #147A7C","cursor":"pointer","padding":"0 24px","margin":"0 10px 4px 0","outline":"none","color":"#147A7C","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
