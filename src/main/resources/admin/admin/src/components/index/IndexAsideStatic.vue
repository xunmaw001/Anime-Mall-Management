<template>
	<div class="menu-preview">
		...
		<el-menu
		  :unique-opened="true"
		  :style='{"border":0,"padding":"0 90px","listStyle":"none","margin":"0","borderRadius":"40px","flexWrap":"wrap","background":"#147A7C","display":"flex","position":"relative"}'
		  default-active="0"
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","minWidth":"180px"}
...
<style lang="scss" scoped>
	.menu-preview {
	  ...
	  .el-menu-horizontal-demo .el-submenu {
		  		  border-radius: 90px 0 0 90px;
		  		  padding: 0;
		  		  box-shadow: 0px 4px 10px 1px rgba(0,0,0,0.3020);
